...
class TestNormalizeAuxProvider:
    ...
    def test_normalize_aux_provider_keeps_named_custom_suffix(self):
        """Named custom provider strips ``custom:`` prefix and returns the name."""
        assert _normalize_aux_provider("custom:my-router") == "my-router"
        assert _normalize_aux_provider("custom:openclaw-router") == "openclaw-router"

    def test_normalize_aux_provider_anonymous_custom_stays_custom(self):
        """Anonymous ``custom`` (no suffix) returns ``custom`` unchanged."""
