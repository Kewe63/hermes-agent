...
class AIAgent:
    ...
    def _maybe_strip_reasoning_content(self, api_messages: list) -> list:
        """Forwarder — see ``agent.chat_completion_helpers._maybe_strip_reasoning_content``."""
        from agent.chat_completion_helpers import _maybe_strip_reasoning_content

        return _maybe_strip_reasoning_content(self, api_messages)
